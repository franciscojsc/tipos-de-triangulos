package br.com.franciscochaves;

import java.util.ArrayList;
import java.util.List;
import java.util.Scanner;

import br.com.franciscochaves.trinagulo.Equilatero;
import br.com.franciscochaves.trinagulo.Escaleno;
import br.com.franciscochaves.trinagulo.Isosceles;
import br.com.franciscochaves.trinagulo.Triangulo;
...
public class Main {
	...
	public static void main(String[] args) {
		...
		List<Isosceles> listIsosceles = new ArrayList<>();
		...
		while (valida) {
			System.out.println("--------------------------------");
			System.out.println("Adicioner os lados do triangulo");
			System.out.println("--------------------------------");
			...
			if (ladoA != 0) {
				...
				if (triangulo instanceof Equilatero) {
					...
					listIsosceles.add((Isosceles) triangulo);
					totalDeTriangulos++;
				}
			}
